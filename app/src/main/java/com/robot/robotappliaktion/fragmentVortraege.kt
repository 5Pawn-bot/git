...
import kotlinx.android.synthetic.main.fragment_blank4.view.*
...
class BlankFragment4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.buttonVortraegeBack.setOnClickListener {Navigation.findNavController(view).navigate(R.id.vortraegetoMainIT)}
